...
//    TODO add custom exceptions
    ...
    public ResponseEntity<String> updateStudent(@PathVariable("id") String studentID, @RequestBody StudentUpdateDto updatedStudentDto) {
        try {
